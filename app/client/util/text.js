import { ItaicIcon, BoldIcon, UnderlineIcon } from "../components/ui/icons"
...
export const colorFromStyles = styles => styles.toJS().reduce((memo, style) => {
...
export const sizeFromStyles = styles => styles.toJS().reduce((memo, style) => {
