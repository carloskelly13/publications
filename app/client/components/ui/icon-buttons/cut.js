...
export const CutIconButton = ({ onClick, margin, active, disabled }) => (
  <IconButton
    disabled={disabled}
    margin={margin}
    onClick={onClick}
  >
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
      <g
        stroke={active || disabled ? AppColors.DarkGray : "#aaa"}
        strokeLinecap="round"
    ...
    <Text block center color={active || disabled ? AppColors.DarkGray : "#aaa"}>Cut</Text>
  </IconButton>
)
