...
export const ShapeAddIconButton = ({ onClick, margin, active }) => (
  <IconButton
    margin={margin}
    onClick={onClick}
  >
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
      <g stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" fill="#fff" fillRule="nonzero">
